...
```{r RSEM, fig.width=12}
grid.arrange(fig1, fig2, ncol=2, top='RSEM hg38')
```
...
grid.arrange(fig1, fig2, ncol=2, top='kallisto hg38')
```
...
grid.arrange(fig1, fig2, ncol=2, top='featureCounts hg38')
```
...
grid.arrange(fig1, fig2, ncol=2, top='featureCounts + hg19')
```
