...
```{r RSEM, fig.width=12}
grid.arrange(fig1, fig2, ncol=2) + ggtitle('RSEM hg38')
```
...
```{r kallisto, fig.width=12}
grid.arrange(fig1, fig2, ncol=2)  + ggtitle('kallisto hg38')
```
...
```{r featureCounts, fig.width=12}
grid.arrange(fig1, fig2, ncol=2) + ggtitle('featureCounts hg38')
```
...
grid.arrange(fig1, fig2, ncol=2) + ggtitle('featureCounts + hg19')
```
