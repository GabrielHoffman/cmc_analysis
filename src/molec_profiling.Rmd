...
L = cbind(L, data.frame(GABAGLU.Other = c(1, 1, 0, 0),
                    MgAs.Other = c(0, 0, 0, 1),
                    Olig.Other = c(0, 0, 1, 0) ))
...
names(tabList) = colnames(coef(fitBasic))

saveRDS(tabList, file='./Roussos_MSSM_MolProf_FANS_4_diffExpression.RDS')

# synapse add --parentid syn22243354 Roussos_MSSM_MolProf_FANS_4_diffExpression.RDS
