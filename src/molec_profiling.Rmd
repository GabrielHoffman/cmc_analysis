...
```{r plot.coef.variation, fig.width=12}
# use colors here
...
ggplot( df, aes(log2(BCV), color=key)) + geom_density() + theme_bw(15) + theme(aspect.ratio=1, plot.title = element_text(hjust = 0.5)) + facet_wrap(~Dataset, ncol=1) + scale_color_manual("Type", values=cols) 
```
