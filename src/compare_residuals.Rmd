...
`r format(sum(corRes>0.95) / length(corRes), digits=3)`% of genes have a correlation > 0.95, and `r format(sum(corRes>0.90) / length(corRes), digits=3)`% of genes have a correlation > 0.90.
